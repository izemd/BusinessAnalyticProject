---
title: "Business Analytic Project"
author: "Izem Demirci"
date: "7/3/2020"
...
source("BusinessAnalyticProject.R")
```

```{r intoduction, echo=FALSE}
shinyUI(fluidPage(
...
```{r Overview dashboard, echo=FALSE}
...
# 
```{r monthly sales header, echo=FALSE}
shinyUI(fluidPage(
...
```{r monthly sales plots, fig.align='center',fig.width=10,fig.height=4, echo=FALSE}
options(scipen=999)
...
```{r Sales for Each Flower Plot, echo=FALSE}
...
# 
```{r total sales header, echo=FALSE}
shinyUI(fluidPage(
...
```{r  total sales plot, fig.align='center', fig.width=10, fig.height=10, echo=FALSE}
...
```{r Earning Per Transaction Plot, echo=FALSE}
...
# 
```{r trend for each flower type header, echo=FALSE}
shinyUI(fluidPage(
...
```{r trend for each flower type, fig.align='center',fig.width=11,fig.height=6, echo=FALSE}
